...
import com.mycompany.myapp.gui.ProfilChForm;
...
public class ServiceCov {
    ...
    public boolean addTask(Cov v) {
        id_ch = ProfilChForm.ch_id;
        System.out.println("page driver = "+ id_ch);
        String url = Statics.BASE_URL + "/addCo_voiturageJSON/new?depart=" + v.getDepart() + "&destination=" + v.getDestination() + "&nmbr_place=" + v.getNbre_place() + "&id_ch=" + id_ch;
