...
public class Voiture implements Serializable {
    ...
    public Voiture(String matricule, String marque, String puissance, String prix_jours, String picture, String energie, String etat) {
        this.matricule = matricule;
        this.marque = marque;
        this.puissance = puissance;
        this.prix_jours = prix_jours;
    ...
    public Voiture(int id, String matricule, String marque, String puissance, String prix_jours, String picture, String energie, String etat) {
        this.id = id;
        this.matricule = matricule;
        this.marque = marque;
        this.puissance = puissance;
